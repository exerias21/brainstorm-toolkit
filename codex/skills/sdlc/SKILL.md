...
`.agents/skills/sdlc/templates/review-correctness-checklist.md` (canonical: `skills/sdlc/templates/review-correctness-checklist.md`)) — as one sequential inline pass over the
