...
agent's prompt includes these two lines verbatim — a sub-agent never sees the orchestrator's
template, so they must be quoted into the dispatched prompt, not cross-referenced:
