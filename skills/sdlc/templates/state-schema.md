...
| `pipeline` | string | optional | Which skill wrote this run: `sdlc`, `sdlc`, or `task`. Absent ⇒ assume `sdlc` (back-compat). Lets `/sdlc-status`, `/repo-health`, and the Stop hook distinguish run types. |
