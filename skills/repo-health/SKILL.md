...
`pipeline.review_fix.max_lenses` *and* sets `models.cap`, note that the adversarial review
stage's reviewer is not governed by `models.cap` (see `skills/sdlc/templates/review-model.md`).
